...
from . import target_nearby  # noqa: F401,E402 (Tier 2, Phase 3 — Target local sweep)
from . import nextdata  # noqa: F401,E402      (Tier 2, Phase 3 — generic Next.js)
from . import walmart  # noqa: F401,E402       (Tier 2, Phase 3 — Walmart, browser + price gate)
